...
def test_audio_ext_returns_audio_kind(filename: str):
...
def test_video_ext_returns_video_kind(filename: str):
    source = Source.from_path(Path(filename))
